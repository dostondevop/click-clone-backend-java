package com.click_clone.click.contoller.service.input.convertor;

import com.click_clone.click.contoller.service.input.dto.InputCreateRequestDto;
import com.click_clone.click.contoller.service.input.dto.InputCreateResponseDto;
import com.click_clone.click.contoller.service.input.dto.InputUpdateResponseDto;
...
public class InputConvertor {
    ...
    public InputUpdateResponseDto inputToUpdateDto(InputEntity input) {
        return InputUpdateResponseDto.builder()
                .id(input.getId())
                .label(input.getLabel())
                .placeholder(input.getPlaceholder())
                .inputType(input.getInputType().toString())
